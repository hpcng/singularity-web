    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          Singularity has freely available support resources to help.
        </p>
      </div>
      <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <p className="mb-3 text-sm text-gray-900">
              The Singularity project uses a Google Group hosted by LBNL. Join to engage in discussions and receive announcements from the project.
            </p>
          </div>
          <Link
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <p className="mb-3 text-sm text-gray-900">
              Want the source code or to contribute? Found an issue? Head over to the Singularity GitHub repo (and don't forget to give the project a <em>star</em>).
            </p>
          </div>
          <Link
